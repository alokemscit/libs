...
import com.aloke.libraries.searchablespinner.adapter.SearchAdapter;
import com.aloke.libraries.searchablespinner.util.StringUtils;
...
public class SearchableSpinnerDialog<T> extends DialogFragment implements SearchView.OnQueryTextListener, SearchView.OnCloseListener {
    ...
    private SearchableSpinner<T> smartMaterialSpinner;
    private boolean isDismissOnSelected = true;

    public SearchableSpinnerDialog() {
    }

    public static SearchableSpinnerDialog newInstance(SearchableSpinner smartMaterialSpinner, List items) {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        this.smartMaterialSpinner = (SearchableSpinner) savedInstanceState.get(INSTANCE_SPINNER_KEY);
