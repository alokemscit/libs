package com.aloke.libraries.signaturepad.ui.svgUtils;
...
public class SvgPathBuilder {
    ...
    private String makeRelativeCubicBezierCurve(final SvgPoint controlPoint1, final SvgPoint controlPoint2, SvgPoint endPoint) {
