...
package com.aloke.libraries.cropper;
...
public class CropImageView extends FrameLayout {
  ...
  private final com.aloke.libraries.cropper.CropOverlayView mCropOverlayView;
  ...
  private WeakReference<com.aloke.libraries.cropper.BitmapLoadingWorkerTask> mBitmapLoadingWorkerTask;
  ...
  public CropImageView(Context context, AttributeSet attrs) {
    ...
    com.aloke.libraries.cropper.CropImageOptions options = null;
    Intent intent = context instanceof Activity ? ((Activity) context).getIntent() : null;
    if (intent != null) {
      Bundle bundle = intent.getBundleExtra( com.aloke.libraries.cropper.CropImage.CROP_IMAGE_EXTRA_BUNDLE);
      if (bundle != null) {
        options = bundle.getParcelable( com.aloke.libraries.cropper.CropImage.CROP_IMAGE_EXTRA_OPTIONS);
      }
    }

    if (options == null) {

      options = new com.aloke.libraries.cropper.CropImageOptions();
    ...
    mCropOverlayView.setCropWindowChangeListener(
        new com.aloke.libraries.cropper.CropOverlayView.CropWindowChangeListener() {
          @Override
  ...
  public Rect getCropRect() {
    ...
    return com.aloke.libraries.cropper.BitmapUtils.getRectFromPoints(
        points,
        orgWidth,
        orgHeight,
  ...
  public Bitmap getCroppedImage(int reqWidth, int reqHeight, RequestSizeOptions options) {
    ...
    if (mBitmap != null) {
      ...
      if (mLoadedImageUri != null
        ...
        com.aloke.libraries.cropper.BitmapUtils.BitmapSampled bitmapSampled =
            com.aloke.libraries.cropper.BitmapUtils.cropBitmap(
                getContext(),
                mLoadedImageUri,
                getCropPoints(),
                mDegreesRotated,
        ...
        croppedBitmap =
            com.aloke.libraries.cropper.BitmapUtils.cropBitmapObjectHandleOOM(
                    mBitmap,
                    getCropPoints(),
                    mDegreesRotated,
                    mCropOverlayView.isFixAspectRatio(),
      ...
      croppedBitmap = com.aloke.libraries.cropper.BitmapUtils.resizeBitmap(croppedBitmap, reqWidth, reqHeight, options);
    }
  ...
  public void setImageBitmap(Bitmap bitmap, ExifInterface exif) {
    ...
    if (bitmap != null && exif != null) {
      com.aloke.libraries.cropper.BitmapUtils.RotateBitmapResult result = com.aloke.libraries.cropper.BitmapUtils.rotateBitmapByExif(bitmap, exif);
  ...
  public void setImageUriAsync(Uri uri) {
    if (uri != null) {
      com.aloke.libraries.cropper.BitmapLoadingWorkerTask currentTask =
      ...
      mCropOverlayView.setInitialCropWindowRect(null);
      mBitmapLoadingWorkerTask = new WeakReference<>(new com.aloke.libraries.cropper.BitmapLoadingWorkerTask(this, uri));
  ...
  public void rotateImage(int degrees) {
    if (mBitmap != null) {
      ...
      com.aloke.libraries.cropper.BitmapUtils.RECT.set(mCropOverlayView.getCropWindowRect());
      float halfWidth = (flipAxes ? com.aloke.libraries.cropper.BitmapUtils.RECT.height() : com.aloke.libraries.cropper.BitmapUtils.RECT.width()) / 2f;
      float halfHeight = (flipAxes ? com.aloke.libraries.cropper.BitmapUtils.RECT.width() : com.aloke.libraries.cropper.BitmapUtils.RECT.height()) / 2f;
      if (flipAxes) {
      ...
      com.aloke.libraries.cropper.BitmapUtils.POINTS[0] = com.aloke.libraries.cropper.BitmapUtils.RECT.centerX();
      com.aloke.libraries.cropper.BitmapUtils.POINTS[1] = com.aloke.libraries.cropper.BitmapUtils.RECT.centerY();
      com.aloke.libraries.cropper.BitmapUtils.POINTS[2] = 0;
      com.aloke.libraries.cropper.BitmapUtils.POINTS[3] = 0;
      com.aloke.libraries.cropper.BitmapUtils.POINTS[4] = 1;
      com.aloke.libraries.cropper.BitmapUtils.POINTS[5] = 0;
      mImageInverseMatrix.mapPoints( com.aloke.libraries.cropper.BitmapUtils.POINTS);
      ...
      mImageMatrix.mapPoints( com.aloke.libraries.cropper.BitmapUtils.POINTS2, com.aloke.libraries.cropper.BitmapUtils.POINTS);
      mZoom /=
          Math.sqrt(
              Math.pow( com.aloke.libraries.cropper.BitmapUtils.POINTS2[4] - com.aloke.libraries.cropper.BitmapUtils.POINTS2[2], 2)
                  + Math.pow( com.aloke.libraries.cropper.BitmapUtils.POINTS2[5] - com.aloke.libraries.cropper.BitmapUtils.POINTS2[3], 2));
      ...
      // width/height
      com.aloke.libraries.cropper.BitmapUtils.RECT.set(
          com.aloke.libraries.cropper.BitmapUtils.POINTS2[0] - halfWidth,
          com.aloke.libraries.cropper.BitmapUtils.POINTS2[1] - halfHeight,
          com.aloke.libraries.cropper.BitmapUtils.POINTS2[0] + halfWidth,
          com.aloke.libraries.cropper.BitmapUtils.POINTS2[1] + halfHeight);

      mCropOverlayView.resetCropOverlayView();
      mCropOverlayView.setCropWindowRect( com.aloke.libraries.cropper.BitmapUtils.RECT);
      applyImageMatrix(getWidth(), getHeight(), true, false);
      handleCropWindowChanged(false, false);
   ...
   */
  void onSetImageUriAsyncComplete(com.aloke.libraries.cropper.BitmapLoadingWorkerTask.Result result) {
  ...
  public Parcelable onSaveInstanceState() {
    ...
    if (mSaveBitmapToInstanceState && imageUri == null && mImageResource < 1) {
      mSaveInstanceStateBitmapUri =
          imageUri =
              com.aloke.libraries.cropper.BitmapUtils.writeTempStateStoreBitmap(
                  getContext(), mBitmap, mSaveInstanceStateBitmapUri);
    }
    if (imageUri != null && mBitmap != null) {
      String key = UUID.randomUUID().toString();
      com.aloke.libraries.cropper.BitmapUtils.mStateBitmap = new Pair<>(key, new WeakReference<>(mBitmap));
      bundle.putString("LOADED_IMAGE_STATE_BITMAP_KEY", key);
    }
    if (mBitmapLoadingWorkerTask != null) {
      com.aloke.libraries.cropper.BitmapLoadingWorkerTask task = mBitmapLoadingWorkerTask.get();
      if (task != null) {
    ...
    mImageMatrix.invert(mImageInverseMatrix);
    mImageInverseMatrix.mapRect( com.aloke.libraries.cropper.BitmapUtils.RECT);

    bundle.putParcelable("CROP_WINDOW_RECT", com.aloke.libraries.cropper.BitmapUtils.RECT);
    ...
    if (state instanceof Bundle) {
      ...
      if (mBitmapLoadingWorkerTask == null
        ...
        if (uri != null) {
          ...
          if (key != null) {
            Bitmap stateBitmap =
                com.aloke.libraries.cropper.BitmapUtils.mStateBitmap != null && com.aloke.libraries.cropper.BitmapUtils.mStateBitmap.first.equals(key)
                    ? com.aloke.libraries.cropper.BitmapUtils.mStateBitmap.second.get()
                    : null;
            com.aloke.libraries.cropper.BitmapUtils.mStateBitmap = null;
    ...
    if (mBitmap != null && width > 0 && height > 0) {
      ...
      if (mDegreesRotated > 0) {
        mImageMatrix.postRotate(
            mDegreesRotated,
            com.aloke.libraries.cropper.BitmapUtils.getRectCenterX(mImagePoints),
            com.aloke.libraries.cropper.BitmapUtils.getRectCenterY(mImagePoints));
        mapImagePointsByImageMatrix();
      }
      ...
      float scale =
          Math.min(
              width / com.aloke.libraries.cropper.BitmapUtils.getRectWidth(mImagePoints),
              height / com.aloke.libraries.cropper.BitmapUtils.getRectHeight(mImagePoints));
      ...
      if (center) {
        ...
        mZoomOffsetX =
            width > com.aloke.libraries.cropper.BitmapUtils.getRectWidth(mImagePoints)
                ...
                : Math.max(
                        Math.min(
                            width / 2 - cropRect.centerX(), -com.aloke.libraries.cropper.BitmapUtils.getRectLeft(mImagePoints)),
                        getWidth() - com.aloke.libraries.cropper.BitmapUtils.getRectRight(mImagePoints))
                    / scaleX;
        mZoomOffsetY =
            height > com.aloke.libraries.cropper.BitmapUtils.getRectHeight(mImagePoints)
                ? 0
                : Math.max(
                        Math.min(
                            height / 2 - cropRect.centerY(), -com.aloke.libraries.cropper.BitmapUtils.getRectTop(mImagePoints)),
                        getHeight() - com.aloke.libraries.cropper.BitmapUtils.getRectBottom(mImagePoints))
                    / scaleY;
      } else {
  ...
  private void updateImageBounds(boolean clear) {
    if (mBitmap != null && !clear) {
      ...
      float scaleFactorWidth =
          100f * mLoadedSampleSize / com.aloke.libraries.cropper.BitmapUtils.getRectWidth(mScaleImagePoints);
      float scaleFactorHeight =
          100f * mLoadedSampleSize / com.aloke.libraries.cropper.BitmapUtils.getRectHeight(mScaleImagePoints);
