...
final class BitmapCroppingWorkerTask
  ...
  private final WeakReference<com.aloke.libraries.cropper.CropImageView> mCropImageViewReference;
  ...
  private final com.aloke.libraries.cropper.CropImageView.RequestSizeOptions mReqSizeOptions;
  ...
  BitmapCroppingWorkerTask(
      com.aloke.libraries.cropper.CropImageView cropImageView,
      Bitmap bitmap,
      float[] cropPoints,
      int degreesRotated,
      ...
      com.aloke.libraries.cropper.CropImageView.RequestSizeOptions options,
      Uri saveUri,
  ...
  protected Result doInBackground(Void... params) {
    try {
      if (!isCancelled()) {
        ...
        Bitmap bitmap =
            com.aloke.libraries.cropper.BitmapUtils.resizeBitmap(bitmapSampled.bitmap, mReqWidth, mReqHeight, mReqSizeOptions);

        if (mSaveUri == null) {
          return new Result(bitmap, bitmapSampled.sampleSize);
        } else {
          com.aloke.libraries.cropper.BitmapUtils.writeBitmapToUri(
  ...
  protected void onPostExecute(Result result) {
    if (result != null) {
      ...
      if (!isCancelled()) {
        com.aloke.libraries.cropper.CropImageView cropImageView = mCropImageViewReference.get();
