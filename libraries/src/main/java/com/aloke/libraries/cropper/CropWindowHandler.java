...
final class CropWindowHandler {
  ...
  public void setInitialAttributeValues(com.aloke.libraries.cropper.CropImageOptions options) {
   ...
   */
  public com.aloke.libraries.cropper.CropWindowMoveHandler getMoveHandler(
      float x, float y, float targetRadius, com.aloke.libraries.cropper.CropImageView.CropShape cropShape) {
    com.aloke.libraries.cropper.CropWindowMoveHandler.Type type =
        cropShape == com.aloke.libraries.cropper.CropImageView.CropShape.OVAL
            ? getOvalPressedMoveType(x, y)
            : getRectanglePressedMoveType(x, y, targetRadius);
    return type != null ? new com.aloke.libraries.cropper.CropWindowMoveHandler(type, this, x, y) : null;
  }
   ...
   * @return the Handle that was pressed; null if no Handle was pressed
   */
  private com.aloke.libraries.cropper.CropWindowMoveHandler.Type getRectanglePressedMoveType(
      float x, float y, float targetRadius) {
    com.aloke.libraries.cropper.CropWindowMoveHandler.Type moveType = null;

    // Note: corner-handles take precedence, then side-handles, then center.
    if (CropWindowHandler.isInCornerTargetZone(x, y, mEdges.left, mEdges.top, targetRadius)) {
      moveType = com.aloke.libraries.cropper.CropWindowMoveHandler.Type.TOP_LEFT;
    } else if (CropWindowHandler.isInCornerTargetZone(
        x, y, mEdges.right, mEdges.top, targetRadius)) {
      moveType = com.aloke.libraries.cropper.CropWindowMoveHandler.Type.TOP_RIGHT;
    } else if (CropWindowHandler.isInCornerTargetZone(
        x, y, mEdges.left, mEdges.bottom, targetRadius)) {
      moveType = com.aloke.libraries.cropper.CropWindowMoveHandler.Type.BOTTOM_LEFT;
    } else if (CropWindowHandler.isInCornerTargetZone(
        x, y, mEdges.right, mEdges.bottom, targetRadius)) {
      moveType = com.aloke.libraries.cropper.CropWindowMoveHandler.Type.BOTTOM_RIGHT;
    } else if (CropWindowHandler.isInCenterTargetZone(
            x, y, mEdges.left, mEdges.top, mEdges.right, mEdges.bottom)
        && focusCenter()) {
      moveType = com.aloke.libraries.cropper.CropWindowMoveHandler.Type.CENTER;
    } else if (CropWindowHandler.isInHorizontalTargetZone(
        x, y, mEdges.left, mEdges.right, mEdges.top, targetRadius)) {
      moveType = com.aloke.libraries.cropper.CropWindowMoveHandler.Type.TOP;
    } else if (CropWindowHandler.isInHorizontalTargetZone(
        x, y, mEdges.left, mEdges.right, mEdges.bottom, targetRadius)) {
      moveType = com.aloke.libraries.cropper.CropWindowMoveHandler.Type.BOTTOM;
    } else if (CropWindowHandler.isInVerticalTargetZone(
        x, y, mEdges.left, mEdges.top, mEdges.bottom, targetRadius)) {
      moveType = com.aloke.libraries.cropper.CropWindowMoveHandler.Type.LEFT;
    } else if (CropWindowHandler.isInVerticalTargetZone(
        x, y, mEdges.right, mEdges.top, mEdges.bottom, targetRadius)) {
      moveType = com.aloke.libraries.cropper.CropWindowMoveHandler.Type.RIGHT;
    } else if (CropWindowHandler.isInCenterTargetZone(
            x, y, mEdges.left, mEdges.top, mEdges.right, mEdges.bottom)
        && !focusCenter()) {
      moveType = com.aloke.libraries.cropper.CropWindowMoveHandler.Type.CENTER;
   ...
   * @return the Handle that was pressed; null if no Handle was pressed
   */
  private com.aloke.libraries.cropper.CropWindowMoveHandler.Type getOvalPressedMoveType(float x, float y) {
    ...
    */
    ...
    com.aloke.libraries.cropper.CropWindowMoveHandler.Type moveType;
    if (x < leftCenter) {
      if (y < topCenter) {
        moveType = com.aloke.libraries.cropper.CropWindowMoveHandler.Type.TOP_LEFT;
